class PropertiesController < ApplicationController
  ...
  def index
    ...
    @properties = @properties.where(['address LIKE ?', "%#{@sp['address']}%"]) if @sp['address'].present? && @sp['address'].strip != ""
    ...
    respond_to do |format|
      ...
      format.turbo_stream { render turbo_stream: turbo_stream.replace("properties", partial: "properties/table", locals: { properties: @properties }) }
    end
  end
